...
def money_num(v):
    """Lee valores numéricos aunque vengan como '$86.190.000'."""
    try:
...
def money_from_row(r, num_col, text_col):
    n = money_num(r.get(num_col, 0))
    return n if n else money_num(r.get(text_col, 0))
...
def pg_edificios():
    ...
    with col_list:
        ...
        for _, r in dff.iterrows():
            tn = money_from_row(r, "totalNum", "total")
            c24n = money_from_row(r, "c24Num", "cuota24")
            c36n = money_from_row(r, "c36Num", "cuota36")
            total = fc(tn)
    ...
    with col_detail:
        ...
        if seleccionado:
            ...
            with tab1:
                ...
                total_n = money_from_row(r, "totalNum", "total")
                c24_n = money_from_row(r, "c24Num", "cuota24")
                c36_n = money_from_row(r, "c36Num", "cuota36")
